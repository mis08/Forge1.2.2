...
{
    private static final DataParameter<Integer> COLOR = EntityDataManager.<Integer>createKey(EntityTippedExpArrow.class, DataSerializers.VARINT);
    private PotionType potion = PotionTypes.EMPTY;
    private final Set<PotionEffect> customPotionEffects = Sets.<PotionEffect>newHashSet();
    private boolean fixedColor;

    public EntityTippedExpArrow(World worldIn)
    {
        super(worldIn);
    }

    public EntityTippedExpArrow(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }

    public EntityTippedExpArrow(World worldIn, EntityLivingBase shooter)
    {
    ...
    {
        EntityExpArrow.registerFixesArrow(fixer, "TippedArrow");
    }
