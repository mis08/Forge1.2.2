...
public class RenderExpArrow<T extends EntityExpArrow> extends Render<T>
{
	private static final ResourceLocation ExpArrowTextures = new ResourceLocation("aluminiummod:textures/entity/entityexparrow.png");
