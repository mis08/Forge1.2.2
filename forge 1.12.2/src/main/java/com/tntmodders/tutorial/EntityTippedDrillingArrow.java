...
public class EntityTippedDrillingArrow extends EntityDrillingArrow{

    private static final DataParameter<Integer> COLOR = EntityDataManager.<Integer>createKey(EntityTippedDrillingArrow.class, DataSerializers.VARINT);
    private PotionType potion = PotionTypes.EMPTY;
    private final Set<PotionEffect> customPotionEffects = Sets.<PotionEffect>newHashSet();
    private boolean fixedColor;

    public EntityTippedDrillingArrow(World worldIn)
    {
        super(worldIn);
    }

    public EntityTippedDrillingArrow(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }

    public EntityTippedDrillingArrow(World worldIn, EntityLivingBase shooter)
    {
    ...
    {
        EntityDrillingArrow.registerFixesArrow(fixer, "TippedArrow");
    }
