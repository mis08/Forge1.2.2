...
public class RenderDrillingArrow <T extends EntityDrillingArrow> extends Render<T>
{

	private static final ResourceLocation DrillingArrowTextures = new ResourceLocation("aluminiummod:textures/entity/entityDrillingArrow.png");
    
	public RenderDrillingArrow(RenderManager renderManagerIn)
    {
